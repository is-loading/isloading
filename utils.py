...
# 设合规 User-Agent，避免被 Wikipedia 服务器限流（429）
# 默认 UA 'wikipedia (https://github.com/goldsmith/Wikipedia/)' 已被 Wikimedia 限流
wikipedia.set_user_agent("video-script-generator/1.0 (https://example.com; contact@example.com)")
...
def generate_script(subject, video_length, creativity, api_key):
    ...
    return search_result, title, script, wiki_ok
